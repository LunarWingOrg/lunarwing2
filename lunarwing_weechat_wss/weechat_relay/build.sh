...
if [ ! -f "$CHANNEL_DIR/../../wit/channel.wit" ]; then
    ...
    if [ -n "$LUNARWING_REPO" ] && [ -f "$LUNARWING_REPO/wit/channel.wit" ]; then
        ...
        echo "Either:"
        echo "  1) Place this project at channels-src/weechat_relay/ inside your lunarwing checkout"
...
echo ""
echo "Done. Restart lunarwing to activate the WeeChat Relay channel."
echo ""
