...
- `USER.md` — everything you know about the user. Update it via `memory_write`
  when you discover meaningful new facts.
- `IDENTITY.md` — the agent's own identity: name, personality, and voice.
  LunarWing is the default name unless the user explicitly wants a rename.
