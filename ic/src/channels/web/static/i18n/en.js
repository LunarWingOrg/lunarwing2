...
I18n.register('en', {
  ...
  'skills.patchesTitle': 'Skill Proposals',
  'skills.patchesLoading': 'Loading proposals...',
  'skills.patchesNone': 'No pending skill proposals.',
  'skills.patchesLoadFailed': 'Failed to load proposals: {message}',
  'skills.patchConfidence': 'Flagged at {pct}% success confidence',
  'skills.usageCount': '{n} uses',
  'skills.updateAvailable': 'Registry update available: v{version}',
  'skills.patchApprove': 'Approve',
  'skills.patchReject': 'Reject',
  'skills.pruneApprove': 'Archive',
  'skills.updateApprove': 'Pull update',
  'skills.patchActionOk': 'Done',
  'skills.patchActionFailed': 'Action failed',
  'skills.proposalKind.patch': 'Patch',
  'skills.proposalKind.prune': 'Prune',
  'skills.proposalKind.update': 'Update',
  'skills.publish': 'Publish',
  'skills.publishTitle': 'Publish this skill to the ClawHub registry',
  'skills.publishSlugPrompt': 'Registry slug (e.g. owner/skill-name):',
  'skills.publishVersionPrompt': 'Version (semver):',
  'skills.publishOk': 'Published {slug} v{version}',
  'skills.publishFailed': 'Publish failed',
