...
I18n.register('zh-CN', {
  ...
  'skills.patchesTitle': '技能建议',
  'skills.patchesLoading': '正在加载建议...',
  'skills.patchesNone': '暂无待处理的技能建议。',
  'skills.patchesLoadFailed': '加载建议失败: {message}',
  'skills.patchConfidence': '在 {pct}% 成功置信度时标记',
  'skills.usageCount': '{n} 次使用',
  'skills.updateAvailable': '有注册表更新可用: v{version}',
  'skills.patchApprove': '批准',
  'skills.patchReject': '拒绝',
  'skills.pruneApprove': '归档',
  'skills.updateApprove': '拉取更新',
  'skills.patchActionOk': '完成',
  'skills.patchActionFailed': '操作失败',
  'skills.proposalKind.patch': '补丁',
  'skills.proposalKind.prune': '清理',
  'skills.proposalKind.update': '更新',
  'skills.publish': '发布',
  'skills.publishTitle': '将此技能发布到 ClawHub 注册表',
  'skills.publishSlugPrompt': '注册表 slug（例如 owner/skill-name）：',
  'skills.publishVersionPrompt': '版本号（semver）：',
  'skills.publishOk': '已发布 {slug} v{version}',
  'skills.publishFailed': '发布失败',
