...
mod tests {
    ...
    async fn seed_identity(db: &Arc<dyn lunarwing::db::Database>, user_id: &str, content: &str) {
    ...
    fn extract_system_prompt(requests: &[Vec<lunarwing::llm::ChatMessage>]) -> Option<String> {
