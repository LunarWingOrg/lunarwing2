...
SEL = {
    ...
    "mcp_install_form":         ".mcp-install-form",
    "mcp_transport_http":       '[data-mcp-transport="http"]',
    "mcp_transport_stdio":      '[data-mcp-transport="stdio"]',
    "mcp_http_fields":          "#mcp-http-fields",
    "mcp_stdio_fields":         "#mcp-stdio-fields",
    "mcp_install_command":      "#mcp-install-command",
    "mcp_install_args":         "#mcp-install-args",
    "mcp_install_env":          "#mcp-install-env",
    "mcp_env_note":             ".mcp-env-note",
