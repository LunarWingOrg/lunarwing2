...
TOOL_NAME="multica-bridge"

echo "==> Building ${TOOL_NAME} WASM tool for LunarWing..."
...
RAW_WASM="${SCRIPT_DIR}/target/wasm32-wasip2/release/multica_bridge_tool.wasm"
...
echo ""
echo "Install:"
echo "  cp ${TOOL_NAME}.wasm ${TOOL_NAME}.capabilities.json ~/.lunarwing/tools/"
